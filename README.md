...
To create a compatible python environment and to not mess up with your global python settings, we recommend creating an independent env called PyLipID using [conda](https://www.anaconda.com/distribution/). 
